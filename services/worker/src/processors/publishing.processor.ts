...
import { RATE_LIMITS } from '@magicomputers/shared';
...
export class PublishingProcessor extends WorkerHost {
  ...
  private async checkAndUpdatePostStatus(postId: string) {
    ...
    if (allPublished) {
      ...
      // TODO: UsageEvent creation disabled - clientId removed from posts
      // Usage events will need to be re-implemented without clientId if needed
