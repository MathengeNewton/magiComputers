...
export default function ComposePage() {
  ...
  const [step, setStep] = useState(1); // Start at step 1 for media selection
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Fetch destinations (tenant-scoped)
  ...
  const STEPS = ['Media', 'Destinations', 'Content', 'Products'];

  return (
    <div className="min-h-screen bg-slate-50">
      <AdminNav title="MagiComputers · Create Post" backHref="/dashboard" />
          ...
          {step === 1 && (
            <div className="animate-fade-in">
              ...
              <div className="flex gap-3">
                <Link
                  href="/dashboard"
                  className="flex-1 bg-gray-100 text-gray-700 py-3.5 px-4 rounded-xl font-semibold hover:bg-gray-200 transition-colors text-center"
                >
                  Cancel
                </Link>
                <button
            ...
            <div className="animate-fade-in">
              ...
              {destinations.length === 0 ? (
                <div className="text-center py-12 bg-gray-50 rounded-xl mb-6">
                  ...
                  <p className="text-gray-600 mb-4">No destinations available. Connect social accounts first.</p>
                  <Link href="/integrations" className="inline-block text-blue-600 hover:text-blue-700 font-semibold">
                    Connect accounts →
                  </Link>
                </div>
              ) : (
