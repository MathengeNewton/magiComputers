        ...
        <div className="prose prose-invert max-w-none space-y-8 text-shop-muted">
          <section>
            ...
            <p className="leading-relaxed">
              By accessing or using MagiComputers (&quot;the Platform&quot;), you agree to be bound by these Terms of Service.
          ...
          <section>
            ...
            <p className="leading-relaxed mb-3">
              You may use MagiComputers to browse products, place orders, and access related services. You agree to:
            </p>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              All content on the platform—including text, graphics, logos, and images—is the property of MagiComputers
          ...
          <section>
            ...
            <p className="leading-relaxed">
              To the fullest extent permitted by law, MagiComputers shall not be liable for any indirect, incidental,
          ...
          <section>
            ...
            <p className="leading-relaxed">
              Your use of the platform is also governed by our Privacy Policy. By using MagiComputers, you consent to
