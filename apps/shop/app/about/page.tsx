      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-shop-muted">
          <p className="text-lg leading-relaxed">
            MagiComputers is Kenya&apos;s largest product marketplace, connecting buyers with trusted sellers
          ...
          <p className="leading-relaxed">
            Thank you for choosing MagiComputers. We&apos;re excited to serve you and look forward to
            growing together.
          </p>
        </div>
