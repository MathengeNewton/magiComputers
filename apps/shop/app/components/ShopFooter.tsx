    ...
    <footer className="bg-shop-card border-t border-shop-border mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-bold text-shop-fg mb-3">MagiComputers</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/shop" className="text-sm text-shop-muted hover:text-shop-fg transition-colors">
                  Shop
                </Link>
              </li>
              <li>
                <Link href="/repair" className="text-sm text-shop-muted hover:text-shop-fg transition-colors">
                  Book repair
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <Link href="/contact" className="text-sm text-blue-500 hover:text-blue-400 hover:underline dark:text-blue-400 dark:hover:text-blue-300">
              Send us a message
            </Link>
          </div>
        </div>
        <div className="mt-8 pt-8 border-t border-shop-border text-center text-sm text-shop-muted">
          © {new Date().getFullYear()} MagiComputers. All rights reserved.
        </div>
      </div>
    </footer>
  );
